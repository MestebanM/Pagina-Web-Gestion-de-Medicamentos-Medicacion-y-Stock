 ...
 */
public class InicioPacienteDecorator extends AutentificacionDecorator{
    
    public InicioPacienteDecorator(IniciarSesion is) {
        super(is);
    ...
    public boolean iniciarSesion( String usuario, String contrasenia) {
         ...
         try {
            ...
            String sql = "SELECT * FROM paciente WHERE contrasenia = ?;";
