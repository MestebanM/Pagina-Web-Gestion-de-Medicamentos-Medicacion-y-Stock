 ...
 */
public class InicioMedicoDecorator extends AutentificacionDecorator{
    
    public InicioMedicoDecorator(IniciarSesion is) {
        super(is);
    ...
    public boolean iniciarSesion(String usuario, String contrasenia) {
        try {
            ...
            String sql = "SELECT * FROM funcionario WHERE contrasenia = ?;";
